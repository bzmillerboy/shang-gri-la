  ...
  <Layout>
	...
	<div id="wrapper" class="clearfix">
		...
		<header id="header" class="transparent-header dark static-sticky" data-sticky-class="not-dark" data-sticky-offset="full" data-sticky-offset-negative="60" data-responsive-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class="container norightpadding clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo"><img src="barber/images/sticky-logo.png" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo"><img src="barber/images/sticky-logo@2x.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
		...
		<section id="slider" class="slider-element slider-parallax page-section full-screen clearfix">
			...
			<div class="slider-parallax-inner" style="background: url('barber/images/hero/hero.jpg') center center no-repeat; background-size: cover;">
				<div class="vertical-middle center" style="z-index: 2;">
					<img src="barber/images/slider-logo.svg" alt="Logo" height="180">
				...
				<div class="slider-social d-none d-lg-block clearfix">
					<a href="http://facebook.com/semicolonweb" target="_blank" class="social-icon si-small si-borderless si-facebook">
						<i class="icon-facebook"></i>
						<i class="icon-facebook"></i>
					</a>
					<a href="http://twitter.com/__semicolon" target="_blank" class="social-icon si-small si-borderless si-twitter">
						<i class="icon-twitter"></i>
						<i class="icon-twitter"></i>
					</a>
					<a href="http://instagram.com/semicolonweb" target="_blank" class="social-icon si-small si-borderless si-instagram">
						<i class="icon-instagram"></i>
						<i class="icon-instagram"></i>
					</a>
					<a href="http://youtube.com/semicolonweb" target="_blank" class="social-icon si-small si-borderless si-youtube">
			...
			<div class="content-wrap nopadding">
					...
					<div class="container clearfix">
						<div class="row clearfix">
							<div class="col-md-3 col-6 d-none d-md-block">
								<img src="barber/images/about/1.jpg" alt="">
							</div>
							<div class="col-md-6 col-12 center" style="padding: 0 50px;">
								<img src="barber/images/icons/cs.svg" alt="" height="60" style="margin-bottom: 20px">
								...
								<img src="barber/images/about/sign.png" alt="" width="200">
							</div>
							<div class="col-md-3 col-6 d-none d-md-block">
								<img src="barber/images/about/2.jpg" alt="">
							</div>
						</div>
					</div>
				</div>
				...
				<div id="service" class="section page-section nobg nopadding notopmargin clearfix">
					...
					<div class="row common-height clearfix bottommargin">
						...
						<!-- Service Image
						============================================= -->
						<div class="col-lg-6 center col-padding parallax" style="background-image: url('barber/images/sections/1.jpg');" data-bottom-top="background-position:0px 100px;" data-top-bottom="background-position:0px -300px;">
								...
								<div class="row clearfix" style="padding: 20px 0">
									<div class="col-lg-10 col-md-8 bottommargin">
										<div class="feature-box fbox-plain">
											<div class="fbox-icon">
												<a href="#"><img src="barber/images/icons/scessior.svg" alt=""></a>
											</div>
									...
									<div class="col-lg-10 col-md-8 bottommargin">
										<div class="feature-box fbox-plain">
											<div class="fbox-icon">
												<a href="#"><img src="barber/images/icons/moustache.svg" alt=""></a>
											</div>
									...
									<div class="col-lg-10 col-md-8 bottommargin">
										<div class="feature-box fbox-plain">
											<div class="fbox-icon">
												<a href="#"><img src="barber/images/icons/comb.svg" alt=""></a>
											</div>
									...
									<div class="col-lg-10 col-md-8 bottommargin">
										<div class="feature-box fbox-plain">
											<div class="fbox-icon">
												<a href="#"><img src="barber/images/icons/time.svg" alt=""></a>
											</div>
									...
									<div class="col-lg-10 col-md-8">
										<div class="feature-box fbox-plain">
											<div class="fbox-icon">
												<a href="#"><img src="barber/images/icons/drier1.svg" alt=""></a>
											</div>
					...
					<div class="container topmargin-lg clearfix">
						...
						<div class="row">
							...
							<div class="col-md-4 center bottommargin-lg">
								<div class="feature-box media-box">
									<div class="fbox-media" style="padding: 0 40px;">
										<a href="#"><img class="rounded-circle img-thumbnail" src="barber/images/features/shave.jpg" alt="Why choose Us?"><span>Shave</span><div class="sale-flash">-30% OFF*</div></a>
									</div>
									<div class="fbox-desc">
							...
							<div class="col-md-4 center bottommargin-lg">
								<div class="feature-box media-box">
									<div class="fbox-media" style="padding: 0 40px;">
										<a href="#"><img class="rounded-circle img-thumbnail" src="barber/images/features/haircut.jpg" alt="Effective Planning"><span>Haircut</span></a>
									</div>
									<div class="fbox-desc">
							...
							<div class="col-md-4 center bottommargin-lg">
								<div class="feature-box media-box">
									<div class="fbox-media" style="padding: 0 40px;">
										<a href="#"><img class="rounded-circle img-thumbnail" src="barber/images/features/hairwash.jpg" alt="Why choose Us?"><span>Hairwash</span></a>
									</div>
									<div class="fbox-desc">
				...
				============================================= -->
				<div id="price" class="section page-section parallax nobottompadding nobottommargin dark" style="background-image: url('barber/images/sections/3.jpg'); background-size: cover; height: 600px" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;"></div>
				...
				<div class="container bottommargin dark clearfix" style="margin-top: -500px">
					<div class="heading-block bottommargin-lg center clearfix">
						<img src="barber/images/icons/wallet-white.svg" alt="" height="40" style="margin-bottom: 20px">
						<h2>Pricing</h2>
					</div>
				...
				<div id="shop" class="section nomargin page-section nobg clearfix">
					...
					<div class="container clearfix">
						<div class="heading-block center clearfix">
							<img src="barber/images/icons/comb3.svg" alt="" height="40" style="margin-bottom: 20px">
							<h2>Shop</h2>
						</div>
						...
						<div class="row clearfix">
							...
							<div class="col-lg-3 col-md-6 bottommargin">
								<div class="iproduct">
									<div class="product-image">
										<a href="#"><img class="image_fade" src="barber/images/shop/1.jpg" alt="High-Heel Girl's Sandals"></a>
							...
							<div class="col-lg-3 col-md-6 bottommargin">
								<div class="iproduct">
									<div class="product-image">
										<a href="#"><img class="image_fade" src="barber/images/shop/2.jpg" alt="High-Heel Girl's Sandals"></a>
										<a href="#" class="shop-icon"><i class="icon-shopping-cart"></i></a>
									</div>
									<div class="product-desc center">
							...
							<div class="col-lg-3 col-md-6 bottommargin">
								<div class="iproduct">
									<div class="product-image">
										<a href="#"><img class="image_fade" src="barber/images/shop/3.jpg" alt="High-Heel Girl's Sandals"></a>
										<a href="#" class="shop-icon"><i class="icon-shopping-cart"></i></a>
									</div>
									<div class="product-desc center">
							...
							<div class="col-lg-3 col-md-6 bottommargin">
								<div class="iproduct">
									<div class="product-image">
										<a href="#"><img class="image_fade" src="barber/images/shop/4.jpg" alt="High-Heel Girl's Sandals"></a>
				...
				============================================= -->
				<div id="testimonial" class="section page-section parallax nobottompadding dark clearfix" style="background-image: url('barber/images/sections/2.jpg'); background-size: cover;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
					<div class="container clearfix">

						<div class="heading-block center">
							<img src="barber/images/icons/stars.svg" alt="" height="50" style="margin-bottom: 20px">
					...
					<div id="oc-clients" class="owl-carousel owl-carousel-full image-carousel carousel-widget topmargin-lg nobottommargin" data-margin="0" data-nav="false" data-pagi="false" data-autoplay="3000" data-items-xs="3" data-items-sm="3" data-items-md="5" data-items-lg="6" data-items-xl="6" data-loop="true" style="z-index: 2; padding: 30px 0; border-top: 1px solid rgba(255,255,255,0.15);">
						...
						<!-- Clients items
						============================================= -->
						<div class="oc-item"><a href="#"><img src="barber/images/clients/1.png" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="barber/images/clients/4.png" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="barber/images/clients/6.png" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="barber/images/clients/2.png" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="barber/images/clients/3.png" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="barber/images/clients/5.png" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="barber/images/clients/7.png" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="barber/images/clients/8.png" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="barber/images/clients/9.png" alt="Brands"></a></div>
				...
				<div class="section nobg nobottommargin topmargin-sm clearfix">
					...
					<div class="container clearfix">
						...
						<div class="heading-block center">
							<img src="barber/images/icons/team.svg" alt="" height="50" style="margin-bottom: 20px">
						...
						<div class="row">
							...
							<div class="col-md-4 bottommargin">
								<div class="team">
									<div class="team-image">
										<img src="barber/images/barbers/1.jpg" alt="John Doe">
							...
							<div class="col-md-4 bottommargin">
								<div class="team">
									<div class="team-image">
										<img src="barber/images/barbers/2.jpg" alt="Josh Thompson">
										<div class="team-overlay">
											<div class="team-social-icons">
												<a href="#" class="social-icon si-rounded si-colored si-small si-facebook" title="Facebook">
													<i class="icon-facebook"></i>
							...
							<div class="col-md-4 bottommargin">
								<div class="team">
									<div class="team-image">
										<img src="barber/images/barbers/3.jpg" alt="Mary Jane">
										<div class="team-overlay">
											<div class="team-social-icons">
												<a href="#" class="social-icon si-rounded si-colored si-small si-facebook" title="Facebook">
													<i class="icon-facebook"></i>
				...
				<!-- Promo Bar
				============================================= -->
				<div class="section nomargin nopadding dark clearfix" style="background: url('barber/images/sections/4.jpg') no-repeat 10% 50%; background-size: cover;">
		...
		<footer id="footer" class="dark" style="background-color: #121212; padding: 60px 0">
			...
			<div class="container clearfix">
				...
				<div class="footer-widgets-wrap center clearfix">
					...
					<img src="barber/images/slider-logo.svg" width="200" alt="">
